...
<!-- Mirrored from iqonic.design/themes/qloud-html/html/cloud-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Apr 2021 04:22:08 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <?php
    ...
    <!-- Header End -->
         ...
         <rs-module-wrap id="rev_slider_5_1_wrapper" data-alias="qloud5" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
            <rs-module id="rev_slider_5_1" style="display:none;" data-version="6.1.8">
               <rs-slides>
                  <rs-slide data-key="rs-5" data-title="Slide" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">
                     <img src="revslider/assets/transparent.png" alt="QLOUD" title="qbanner1" width="1600" height="867" data-bg="c:#eff1fe;" data-parallax="off" class="rev-slidebg" data-no-retina>
<!--
                     --><rs-layer
                        ...
                        style="z-index:8;"
                     >Cloud <span class="bluetext">Analytics</span><br>Everything You Need 
                     </rs-layer><!--
                     ...
                     --><rs-layer
                        ...
                        style="z-index:12;"
                     ><img src="revslider/assets/home52.png" alt="qloud" width="593" height="619" data-no-retina> 
                     </rs-layer><!--
-->                  </rs-slide>
               </rs-slides>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6 col-sm-12 wow fadeInRight">
                     <div class=" text-left iq-title-box iq-title-default iq-title-box-2">
                        ...
                        Fully managed serverless Analytics  </h2>
                        <p class="iq-title-desc pr-lg-5">Seamlessly unlock business insights with Qloud Platform’s fully managed, proven, end-to-end data analytics products. Remove operational complexities of data analytics with a serverless approach<br> and make important business decisions quickly and efficiently.</p></div>
                        <div class="iq-btn-container">
                           <a class="iq-button iq-btn-round has-icon btn-icon-right d-inline" href="#">
                              Read More
                           </a>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="iq-icon-box iq-icon-box-style-4   text-center iq-box-shadow">
                           ...
                           <div class="icon-box-content">
                              <h5 class="icon-box-title"><a href="#">Cloud Dataflow</a>
                              </h5>
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="iq-icon-box iq-icon-box-style-4   text-center iq-box-shadow">
                           ...
                           <div class="icon-box-content">
                              <h5 class="icon-box-title"><a href="#">Cloud Dataproc</a>
                              </h5>
                              <p class="icon-box-desc"> It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.
                              </p>
                              <div class="iq-btn-container">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="iq-icon-box iq-icon-box-style-4   text-center iq-box-shadow">
                           ...
                           <div class="icon-box-content">
                              <h5 class="icon-box-title"><a href="#">Cloud Pub/Sub</a>
                              </h5>
                              <p class="icon-box-desc"> It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.
                              </p>
                              <div class="iq-btn-container">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="iq-icon-box iq-icon-box-style-4   text-center iq-box-shadow">
                           ...
                           <div class="icon-box-content">
                              <h5 class="icon-box-title"><a href="#">Cloud Data Transfer</a>
                              </h5>
                              <p class="icon-box-desc"> It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.
                              </p>
                              <div class="iq-btn-container">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="1.0s">
                        <div class="iq-icon-box iq-icon-box-style-4   text-center iq-box-shadow">
                           ...
                           <div class="icon-box-content">
                              <h5 class="icon-box-title"><a href="#">Cloud Data Fusion</a>
                              </h5>
                              <p class="icon-box-desc"> It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.
                              </p>
                              <div class="iq-btn-container">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="1.2s">
                        <div class="iq-icon-box iq-icon-box-style-4   text-center iq-box-shadow">
                           <div class="icon-box-img">
                           <img src="images/icon-box/14.png" class="img-fluid" alt="qloud">   </div>
                           <div class="icon-box-content">
                              <h5 class="icon-box-title"><a href="#">Cloud Composer</a>
                              </h5>
                              <p class="icon-box-desc"> It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.
                              </p>
                              <div class="iq-btn-container">
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-5 col-sm-12">
                        <div class="about-analytics">
                           <img src="images/client/c4.png" class="attachment-large img-fluid size-large" alt="" >
                  ...
                  <div class="row">
                     <div class="col-lg-5 col-sm-12 align-self-center mb-4 mb-lg-0">
                        <div class=" text-left iq-title-box iq-title-white iq-title-box-2">
                           ...
                           <h2 class="iq-title text-capitalize">Free until you're<br> ready to launch</h2>
                           <p class="iq-title-desc">Build your site for free and take as long as you need. (That’s right, no trial here.) just add a site plan and custom domain when you’re ready for the world.</p></div>
                           <div class="iq-btn-container">
                        ...
                        <div class="col-lg-7 col-sm-12">
                           ...
                           <div class="iq-client iq-client-style-1 ">
                              <ul class="iq-client-col-4 iq-client-grid">        <li>
                                 <img src="images/client/c1-1.png" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/c1-2.png" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/c1-3.png" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/c1-4.png" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/c1-5.png" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/C1-6.html" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/C1-7.html" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/C1-8.html" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/C1-9.html" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/C1-10.html" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/c1-11.png" class="img-fluid" alt="client-img">
                              </li>
                              <li>
                                 <img src="images/client/c1-12.png" class="img-fluid" alt="client-img">
                              </li>
                           </ul>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-lg-5 col-sm-12 align-self-center mb-5 mb-lg-0 wow fadeInUp" data-wow-delay="0.2s">
                        <div class=" text-left iq-title-box iq-title-default iq-title-box-2">
                           ...
                           <h2 class="iq-title">
                           Big DataGuides and Resources</h2>
                           <p class="iq-title-desc">Seamlessly unlock business insights with Qloud Platform’s fully managed, proven, end-to-end data analytics products. Remove operational complexities of data analytics with a serverless approach and make important business decisions quickly and efficiently.</p></div>
                           <div class="iq-btn-container">
                              <a class="iq-button iq-btn-round has-icon btn-icon-right d-inline" href="contact-us-1.html">
                           ...
                           <div class="row">
                              <div class="col-lg-6 col-md-6">
                                 <div class="iq-icon-box iq-icon-box-style-8  wow fadeInUp" data-wow-delay="0.2s">
                                    ...
                                    <img src="images/icon-box/13.png" class="img-fluid" alt="qloud">   </div>
                                    <div class="icon-box-content">
                                       <h5 class="icon-box-title"> <a href="#">Marketing</a>
                                       </h5>
                                 ...
                                 <div class="col-lg-6 col-md-6">
                                 <div class="iq-icon-box iq-icon-box-style-8  wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="icon-box-img">
                                    <img src="images/icon-box/03.png" class="img-fluid" alt="qloud"> </div>
                                    <div class="icon-box-content">
                                       <h5 class="icon-box-title"> <a href="#">Social Services</a>
                                       </h5>
                                       <p class="icon-box-desc"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
                                    </div>
                                 </div>
                            ...
                            <div class="row">
                              <div class="col-lg-6 col-md-6">
                                 <div class="iq-icon-box iq-icon-box-style-8  wow fadeInUp" data-wow-delay="0.6s">
                                    ...
                                    <img src="images/icon-box/14.png" class="img-fluid" alt="qloud">   </div>
                                    <div class="icon-box-content">
                                       <h5 class="icon-box-title"> <a href="#">Clean Design</a>
                                       </h5>
                                       <p class="icon-box-desc"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
                                    </div>
                                 </div>
                               ...
                               <div class="col-lg-6 col-md-6">
                                 <div class="iq-icon-box iq-icon-box-style-8  wow fadeInUp" data-wow-delay="0.8s">
                                    <div class="icon-box-img">
                                    <img src="images/icon-box/16.png" class="img-fluid" alt="qloud"> </div>
                                    <div class="icon-box-content">
                                       <h5 class="icon-box-title"> <a href="#">Creative Ideas</a>
                                       </h5>
                                       <p class="icon-box-desc"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
                                    </div>
                                 </div>
               ...
               <section class="iq-getstarted">
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="iq-btn-container">
                        <a class="iq-button d-inline" href="contact-us-1.html">Try Free</a>
                        </div>
                        </div>
                        ...
                        <a class="iq-button iq-btn-outline d-inline" href="contact-us-1.html">   Contact Sales   
                        </a>
                        </div>
                        <div class="iq-btn-container d-inline-block">
                        <a class="iq-button iq-btn-outline d-inline" href="contact-us-1.html">  Find a partner   
                        </a>
                        </div>
                        </div>
                     </div>
...
<!-- Mirrored from iqonic.design/themes/qloud-html/html/cloud-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Apr 2021 04:22:27 GMT -->
</html>