...
<!-- Mirrored from iqonic.design/themes/qloud-html/html/cloud-compute.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Apr 2021 04:23:06 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    ...
    style="z-index:11;"
    >Lorem ipsum dolor sit amet, consectetur adipiscing<br> elit, sed do eiusmod facilisis.
    </rs-layer><!--
    --><rs-layer
          ...
          <div class="col-lg-12 col-md-12">
            <div class="iq-client iq-client-style-1 text-center iq-has-grascale">
              <div id="my-carousel" class="owl-carousel" data-dots="false" data-nav="false" data-items="6" data-items-laptop="5" data-items-tab="3" data-items-mobile="2" data-items-mobile-sm="1" data-autoplay="true" data-loop="true" data-margin="30">
                ...
                <div class="item">
                  <div class="iq-client-img">
                    <img src="images/client/c2.png" class="img-fluid" alt="client-img" />
                  </div>
                </div>
                <div class="item">
                  <div class="iq-client-img">
                    <img src="images/client/c3.png" class="img-fluid" alt="client-img" />
                  </div>
                </div>
                <div class="item">
                  <div class="iq-client-img">
                ...
                <div class="item">
                  <div class="iq-client-img">
                    <img src="images/client/c6.png" class="img-fluid" alt="client-img" />
                  </div>
                </div>
                <div class="item">
                  <div class="iq-client-img">
                    <img src="images/client/c7.png" class="img-fluid" alt="client-img" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-12 wow fadeInUp">
            <div class="text-center iq-title-box iq-title-default iq-title-box-2">
              ...
              <span class="iq-subtitle">Product</span>
              <h2 class="iq-title">Explore compute products</h2>
            </div>
          </div>
        </div>
        <div class="row iq-compute-list wow fadeInUp">
          <div class="col-lg-4 col-md-6 border-right">
            <h4 class="heading-title mb-4 mt-4">Compute Engine</h4>
            <p>It is a long established fact that a reader will be distracted by the readable.</p>
          </div>
          <div class="col-lg-4 col-md-6 border-right pl-lg-5 mb-4 mb-lg-0">
            <h4 class="heading-title mb-4 ">Common uses</h4>
            <div class="iq-list  iq-one-column">
              <ul class="iq-list-with-icon">
                <li>
                <i class="ion ion-checkmark-round"></i>LOB apps</li>
                <li>
                <i class="ion ion-checkmark-round"></i>Web hosting</li>
                <li>
                <i class="ion ion-checkmark-round"></i>Databases</li>
                <li>
                <i class="ion ion-checkmark-round"></i>Unlimited Applications</li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4 pl-lg-5">
            <h4 class="heading-title mb-4 ">Industry</h4>
            <div class="iq-list  iq-one-column">
              <ul class="iq-list-with-icon">
                <li>
                <i class="ion ion-checkmark-round"></i>Education</li>
                <li>
                <i class="ion ion-checkmark-round"></i>Energy</li>
                <li>
                <i class="ion ion-checkmark-round"></i>Financial servicesl</li>
                <li>
                <i class="ion ion-checkmark-round"></i>Healthcare</li>
                <li>
                <i class="ion ion-checkmark-round"></i>Life sciences</li>
              </ul>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="text-center iq-title-box iq-title-default iq-title-box-2">
                      ...
                      <h2 class="iq-title">Our Best Services</h2>
                    </div>
                  </div>
                </div>
                <div class="row">
                      ...
                      <div class="row ">
                        <div class="col-lg-4">
                          <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active" data-toggle="pill" href="#tabs-041" role="tab">
                                ...
                                <h6 class="tab-title">Compute Engine</h6></div></div>
                              </a>
                            ...
                            <a class="nav-link " data-toggle="pill" href="#tabs-141" role="tab">
                              ...
                              <h6 class="tab-title">Application Services</h6></div></div>
                            </a>
                          </li><li class="nav-item">
                          <a class="nav-link " data-toggle="pill" href="#tabs-241" role="tab">
                            ...
                            <h6 class="tab-title">Migrate for Compute Engine</h6></div></div>
                          </a>
                        </li><li class="nav-item">
                        <a class="nav-link " data-toggle="pill" href="#tabs-341" role="tab">
                          <div class="media"><i class="fa fa-users" aria-hidden="true"></i><div class="media-body">
                          <h6 class="tab-title">Sales-talent Nodes</h6></div></div>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link " data-toggle="pill" href="#tabs-441" role="tab">
                          <div class="media"><i class="fa fa-bar-chart" aria-hidden="true"></i><div class="media-body">
                          <h6 class="tab-title">Cloud GPUs</h6></div></div>
                        </a>
                      </li>
                      <li class="nav-item">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane active" id="tabs-041" role="tabpanel">
                        <div><div class="ml-lg-5 t">
                          ...
                          <h4 class="mb-3 mt-4">Compute Engine</h4>
                          There are many variations of passages of Lorem Ipsum available,
                          but
                          the majority have suffered alteration in some form, by injected humour.
                        </div></div>
                      </div><div class="tab-pane " id="tabs-141" role="tabpanel">
                      <div><h4 class="mb-3">Real-Time Actionable Insights</h4>
...
<!-- Mirrored from iqonic.design/themes/qloud-html/html/cloud-compute.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Apr 2021 04:23:19 GMT -->
</html>