            ...
            <div class="row">
                <div class="col-lg-4  col-md-6">
                    <div class="iq-icon-box iq-icon-box-style-2 text-left ">
                        ...
                        <div class="icon-box-content">
                            <h5 class="icon-box-title"> <a href="javascript:void(0)">Location</a>
                           </h5>

                            <p class="icon-box-desc">Netmax India Solution Pvt Ltd <br>Third Floor ,2092/37,Naiwalan,Karol Bagh,New Delhi 110005 </p>
                        </div>
                ...
                <div class="col-lg-4  col-md-6">
                    <div class="iq-icon-box iq-icon-box-style-2 text-left ">
                        ...
                        <div class="icon-box-content">
                            <h5 class="icon-box-title"> <a href="javascript:void(0)">Email</a>
                           </h5>

                            <p class="icon-box-desc"> <a href="https://iqonic.design/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8ffcfaffffe0fdfbcfe6fee0e1e6ecfbe7eae2eafca1ece0e2">[support@voicetech.co.in]</a>  </p>
                        </div>
                ...
                <div class="col-lg-4  col-md-6">
                    <div class="iq-icon-box iq-icon-box-style-2 text-left ">
                        ...
                        <div class="icon-box-content">
                            <h5 class="icon-box-title"> <a href="javascript:void(0)">Phone</a>
                           </h5>

                            <p class="icon-box-desc">+0114041-4041,8826114009<br>1800-532-5700</p>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14005.244767387776!2d77.1962024!3d28.6503995!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x6d58c483317e0737!2sNetmax%20Computers!5e0!3m2!1sen!2sin!4v1640692654752!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                </div>
