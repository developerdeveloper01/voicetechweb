...
*/
    .card2 {
        ...
        box-shadow: 4px 2px 8px 3px #d2d0d0d1;
        border-radius: 10px;
    }
...
<body>
  ...
  <?php
    ...
    <!-- login2 -->
    <div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto" style="padding-top: 100px!important">
        <div class="card card0 border-0">
            <div class="row d-flex">
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        <!--<div class="row"> <a href="index-2.php"> <img src="images/logo-black.png" class="logo"></a>-->
                        <!--</div>-->
                    ...
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <form id="inquiryform" method="post">
                            <div class="row px-3"> <label class="mb-1">
                                    <h6 class="mb-0 text-sm">Name <span style="color: red;">*</span></h6>
                                </label> <input type="text" id="name" placeholder="John Doe"> </div>
                            <div class="row px-3"> <label class="mb-1" required>
                                    <h6 class="mb-0 text-sm">Product (optional)</h6>
                                </label> <select id="product">
                                    <option value="ivr">IVR Solution</option>
                                    <option value="sip">Cloud Call</option>
                                    <option value="tollfree">Toll Free Number</option>
                                    <option value="outbound">Outbound Calling</option>
                                    <option value="virtualnum">Virtual Number</option>
                                </select> </div>
                            <div class="row">
                            ...
                            <div class="row px-3">  -->
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    </label> <input class="mb-4" type="email" id="email" placeholder="Enter Email"
                                        required>
                                </div>
                            </div>
                            <div class="row px-3">
                                <label class="mb-1">
                                    <h6 class="mb-0 text-sm">Description<span style="color: red;">*</span></h6>
                                </label> <textarea class="mb-4" type="text" id="desc"
                                    placeholder="Need IVR,Toll Free...." rows="3" required></textarea>
                            </div>
                            <!-- <div class="row px-3"> <label class="mb-1">
                            ...
                            <div class="row mb-3 px-3"> <a type="submit" id="sendiq"
                                    class="btn btn-blue text-center">Send
                                    Inquiry</a></div>
                                    </form>
                    </div>
                ...
                <div class="modal" id="postinquirymodal" tabindex="-1" role="dialog">
...
$(document).ready(function() {
    $("#sendiq").click(function(event) {
                ...
                topost.done(function(data) {
                    ...
                    $("#postinquirymodal").modal("show", function() {
                        $("#result").text("Inquiry Sent");
                    });
                    $("#name").val("");
                    $("#product").val("");
